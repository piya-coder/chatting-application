            ...
            <div className=" mt-[90px] ">
              <ul className=" flex flex-col justify-center align-middle items-center gap-y-12 ">
               ...
               text-base-color hover:text-green-700 "
                ...
                <li className=" w-[160px] h-[90px] bg-white ml-4 rounded-l-[20px] flex justify-center items-center ">
                  <FaRegMessage
                    className=" w-[40px] h-[40px] relative
               text-base-color hover:text-green-700 "
                  />
               ...
               text-base-color hover:text-green-700 "
                ...
                <li className=" cursor-pointer ">
                  <IoLogOutOutline className=" w-[40px] h-[40px] text-white mt-[60px] cursor-pointer " />
                </li>
              </ul>
            </div>
          </div>
